...
1. Load the `brief-format` skill before writing.
2. Use only facts present in the research material passed in your message.
3. Return structured output: `summary`, `findings`, and `sources`.
